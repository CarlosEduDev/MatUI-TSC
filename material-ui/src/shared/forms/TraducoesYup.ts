...
setLocale({
  ...
  string: {
    ...
    min: ({min}) => `O campo precisa ter no minimo ${min} caracteres`,
  ...
  number: {
    ...
    lessThan: ({less}) => `O campo precisa ter um valor maior que ${less}`,
    max: ({max}) => `O campo pode ter um valor maior que ${max} caracteres`,
    min: ({min}) => `O campo precisa ter um valor com menos ${min} caracteres`,
  },
  boolean: {},
  object: {},
  array: {},
